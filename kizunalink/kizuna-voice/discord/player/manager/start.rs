...
/// Stops and removes the current track while preserving other mixer tracks and
/// sound-effect layers. Emits `TrackEnd: Replaced` when the track was not already
/// stopped and its player response is available.
